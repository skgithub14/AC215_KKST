 ...
 **api-service** folder contains codes for the models and API server
...
**frontend-react** folder contains codes for the React frontend 
...
**deployment** folder contains scripts for deploying the App on Google Cloud Platform (GCP)
